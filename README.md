...
- `slippage_per_contract`: Set at **$2.50** per round turn, this accounts for the difference between expected and actual execution prices. This is calculated based on the commmission fee, capturing realistic market impact under normal liquidity conditions. Slippage varies by instrument tick value: ES ($12.50/tick), NQ ($5/tick), YM ($5/tick), and EMD ($10/tick).
